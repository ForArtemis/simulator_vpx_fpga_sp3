...
set result [ run_cg_create "xilinx.com:ip:dcmbd_sp:13.1" "tmp" "Board Deskew with an Internal Deskew (DCM_SP)" "Board Deskew with an Internal Deskew (DCM_SP) (xilinx.com:ip:dcmbd_sp:13.1) generated by Project Navigator" xc3s400an-5fgg400 Verilog ]
